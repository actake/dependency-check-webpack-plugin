  ...
  apply(compiler) {
    ...
    const commonHandler = (_, callback) => {
      try {
        ...
        if (!error && error.code !== ERROR_CODE.LOSE_DEPENDENCY) {
        ...
        console.log(
          "*** detect dependency update, will execute install command *** "
        );
...
module.exports.DependencyCheckWebpackPlugin = DependencyCheckWebpackPlugin;
